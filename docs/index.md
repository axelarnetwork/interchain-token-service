...
| Name | Type    | Description                              |
| ---- | ------- | ---------------------------------------- |
| [0]  | address | tokenAddress\_ The address of the token. |
...
| Name     | Type  | Description           |
| -------- | ----- | --------------------- |
| params\_ | bytes | The setup parameters. |
...
| Name     | Type  | Description                                               |
| -------- | ----- | --------------------------------------------------------- |
| params\_ | bytes | The parameters to be used to initialize the TokenManager. |
