...
interface IFlowLimit {
    ...
    error FlowAmountOverflow(uint256 flowAmount, uint256 flowToAdd, address tokenManager);
    error FlowAmountExceededLimit(uint256 limit, uint256 flowAmount, address tokenManager);
