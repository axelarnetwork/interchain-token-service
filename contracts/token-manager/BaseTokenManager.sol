...
/**
 * @title BaseTokenManager
 * @notice Base contract containing common functionality for token managers
 * @dev This contract contains all shared functionality between different TokenManager implementations
 */
abstract contract BaseTokenManager is ITokenManager, Operator, FlowLimit, Implementation, Multicall {
    ...
    /**
     * @notice Constructs the BaseTokenManager contract.
     ...
     */
    function setup(bytes calldata params_) external virtual override(Implementation, IImplementation) onlyProxy {
     ...
     */
    function approveService() external virtual onlyService {
        /**
     ...
     */
    function mintToken(address tokenAddress_, address to, uint256 amount) external virtual onlyService {
     ...
     */
    function burnToken(address tokenAddress_, address from, uint256 amount) external virtual onlyService {
