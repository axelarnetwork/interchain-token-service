 ...
 */
contract InterchainTokenServiceProxy is
    Upgradable,
    Operator,
    Pausable,
    Multicall,
    ...
    IInterchainTokenServiceProxy
{
    ...
    address public immutable interchainTokenServiceImplementation;
     ...
     * @param interchainTokenServiceImplementation_ The interchainTokenServiceImplementation implementation.
     */
    constructor(
        ...
        address interchainTokenServiceImplementation_
    ) {
        if (
            ...
            interchainTokenServiceImplementation_ == address(0)
        ) revert ZeroAddress();
        ...
        interchainTokenServiceImplementation = interchainTokenServiceImplementation_;
    }
    ...
    /**
     * @dev Fallback function. Delegates the call to the current InterchainTokenServiceImplementation contract.
     */
    fallback() external payable virtual {
        address implementation_ = interchainTokenServiceImplementation;
        assembly {
