 ...
 * @notice This contract is used to deploy new instances of the HyperliquidInterchainToken contract.
 * @dev This is specifically for Hyperliquid chain to ensure slot 0 compatibility.
 */
contract HyperliquidInterchainTokenDeployer is IInterchainTokenDeployer, Create3Fixed {
    address public immutable implementationAddress;

    /**
     * @notice Constructor for the HyperliquidInterchainTokenDeployer contract.
     * @param implementationAddress_ Address of the HyperliquidInterchainToken contract.
     */
    ...
    /**
     * @notice Deploys a new instance of the HyperliquidInterchainToken contract.
