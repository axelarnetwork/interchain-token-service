...
/**
 * @title NoReEntrancy
 * @notice This contract provides a mechanism to prevent re-entrancy attacks by
...
contract NoReEntrancy is INoReEntrancy {
     ...
     * @return entered A boolean representing the entered status. True if it is already executing, false otherwise.
     */
     ...
     * @param entered A boolean representing the entered status. True if it is already executing, false otherwise.
     */
